        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartsProducts_Cart_CartId",
                        column: x => x.CartId,
                        principalTable: "Cart",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "111111111111111111111111", "https://odai.core.windows.net/images/.jpg", "Beauty" },
                    { 2, "22222222222222222", "https://odai.core.windows.net/images/.jpg", "Clothes" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Amount", "Description", "ImageURL", "Name", "Price" },
                values: new object[,]
                {
                    { 1, 0, "1111111111111111", "https://odai.core.windows.net/images/.jpg", "Name1", 5.0 },
                    { 2, 0, "2222222222222222", "https://odai.core.windows.net/images/.jpg", "Name2", 10.0 },
                    { 3, 0, "3333333333333333333", "https://odai.core.windows.net/images/.jpg", "Name3 ", 15.0 }
                });
